...
export const up = (pgm) => {
  pgm.db.query({
    text: `
    INSERT INTO users (user_id, name, email, contact_no, created_at) VALUES
...
(1,'Wireless Mouse','Ergonomic wireless mouse',799,50),
(2,'Mechanical Keyboard','RGB mechanical keyboard',3499,30),
(3,'Bluetooth Headphones','Noise cancelling headphones',2999,25),
(4,'USB-C Charger','Fast charging adapter',999,100),
(5,'Gaming Laptop','High performance laptop',85000,15),
(6,'Smartphone','5G Android smartphone',25000,20),
(7,'Smartwatch','Fitness tracking watch',5999,35),
(8,'Office Chair','Ergonomic chair',7000,10),
(9,'LED Monitor','24 inch FHD monitor',12000,25),
(10,'External HDD','1TB external hard drive',4500,40),
(11,'Tablet','10 inch Android tablet',15000,30),
(12,'Power Bank','20000mAh power bank',1500,65),
(13,'Webcam','HD webcam',1800,45),
(14,'Microphone','USB condenser mic',3500,25),
(15,'Printer','Wireless printer',9000,22),
(16,'Router','Dual band router',2500,30),
(17,'Graphic Tablet','Drawing tablet',4000,25),
(18,'SSD','500GB SSD',5500,20),
(19,'RAM 16GB','DDR4 RAM',4200,35),
(20,'Gaming Mousepad','Extended mousepad',600,50),
(21,'Keyboard Cover','Silicone cover',300,75),
(22,'Laptop Stand','Adjustable stand',1200,45),
(23,'Desk Lamp','LED desk lamp',900,65),
(24,'Cooling Pad','Laptop cooling pad',1100,35),
(25,'VR Headset','Virtual reality headset',22000,15),
(26,'Drone','Camera drone',45000,5),
(27,'Action Camera','4K action cam',15000,10),
(28,'Smart TV','50 inch 4K TV',55000,8),
(29,'Speakers','Bluetooth speakers',3500,30),
(30,'Fitness Band','Activity tracker',2500,45),
(31,'Mouse Bungee','Gaming accessory',700,60),
(32,'Surge Protector','6 plug extension',800,45),
(33,'Ethernet Cable','5m LAN cable',400,75),
(34,'HDMI Cable','2m HDMI cable',500,65),
(35,'Laptop Bag','Waterproof backpack',2000,25),
(36,'Portable Monitor','15 inch portable monitor',18000,15),
(37,'NAS Storage','2 bay NAS',30000,10),
(38,'Graphics Card','Mid range GPU',40000,5),
(39,'CPU Cooler','Liquid cooler',6000,25),
(40,'Smart Bulb','WiFi smart bulb',1500,65),
(41,'Tripod','Camera tripod',2500,35),
(42,'Green Screen','Studio backdrop',3500,25),
(43,'Drawing Stylus','Digital pen',1800,45),
(44,'Projector','Home theater projector',45000,8),
(45,'Wireless Earbuds','True wireless earbuds',3500,35),
(46,'Monitor Arm','Adjustable arm',2500,25),
(47,'Laptop Sleeve','Protective sleeve',800,45),
(48,'Phone Case','Shockproof case',500,65),
(49,'Screen Protector','Tempered glass',300,75),
(50,'Memory Card','128GB SD card',1200,30);
